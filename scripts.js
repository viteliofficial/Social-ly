...
1. **Firebase Initialization**:
   - The Firebase configuration is provided and initialized as before.

2. **Shuffling Function**:
   - The `shuffle` function takes an array and shuffles its elements using the Fisher-Yates algorithm.

3. **Creating Video Elements**:
   - The `createVideoElement` function creates and appends video elements to the DOM.

4. **Fetching User Videos**:
   - The `fetchUserVideos` function