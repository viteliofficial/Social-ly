        ...
        uploadTask.on('state_changed',
          (snapshot) => {
            ...
            uploadInfo.innerHTML = `
              Upload Progress: ${progress.toFixed(2)}%<br>
              Uploaded: ${(snapshot.bytesTransferred / (1024 * 1024)).toFixed(2)} MB<br>
              Total Size: ${(snapshot.totalBytes / (1024 * 1024)).toFixed(2)} MB
            `;
          },
          (error) => {
            ...
            uploadTask.snapshot.ref.getDownloadURL().then((downloadURL) => {
              ...
              database.ref('User/' + user.uid + '/video/' + newVideoKey).set({
                ...
                if (error) {
                  ...
                  uploadInfo.innerHTML = ''; // Clear upload info
                }
              });
            });
          }
